...
public class Managers : MonoBehaviour
{
    ...
    public BaseMiner4 miner4; // New variable for manager 4
    public BaseMiner5 miner5; // New variable for manager 5
    public BaseMiner6 miner6; // New variable for manager 6
