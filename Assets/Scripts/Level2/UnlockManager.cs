...
public class UnlockManager : MonoBehaviour
{
    ...
    public BaseMiner4 miner4;
    public BaseMiner5 miner5; // Added BaseMiner5
    public BaseMiner6 miner6; // Added BaseMiner6
    ...
    int shaft3Price = 100;
    int shaft4Price = 500;
    int shaft5Price = 1500; // Added shaft5Price
    int shaft6Price = 3000; // Added shaft6Price

    int autominingprice1 = 50;
    int autominingprice2 = 100;
    int autominingprice3 = 250;
    int autominingprice4 = 400;
    int autominingprice5 = 800; // Added autominingprice5
    int autominingprice6 = 1000; // Added autominingprice6

    int speedprice1 = 15;
    int speedprice2 = 20;
    int speedprice3 = 25;
    int speedprice4 = 30;
    int speedprice5 = 35; // Added speedprice5
    int speedprice6 = 40; // Added speedprice6

    int powerprice1 = 15;
    int powerprice2 = 20;
    int powerprice3 = 25;
    int powerprice4 = 30;
    int powerprice5 = 35; // Added powerprice5
    int powerprice6 = 40; // Added powerprice6
