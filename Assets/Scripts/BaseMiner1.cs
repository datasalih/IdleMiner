...
public class BaseMiner1: MonoBehaviour
{
    ...
    public int miningspeed1=5;
    public int miningpower1 = 5;
 ...
 //   public bool collecting3;
   ...
   // public static int goldAmount = 0; // Make goldAmount static
    ...
    private void Start()
    {
        ...
        miningspeed1 = PlayerPrefs.GetInt("speed1", miningspeed1);
        miningpower1 = PlayerPrefs.GetInt("power1", miningpower1);
   ...
   /* public void MoveMiner2()
                    ...
                    transform.DOMoveX(depositLocation.position.x, moveSpeed).SetEase(Ease.Linear).OnComplete(() =>
                    {
                        ...
                        DOVirtual.DelayedCall(5f, () =>
                        {
                            ...
                            transform.DORotate(new Vector3(0, 0, 0), 0.5f).SetEase(Ease.Linear).OnComplete(() =>
                            {
                                ...
                                anim.SetBool("Idle", true);
                                coinSound.GetComponent<AudioSource>().Play();
                                goldAmount += 10;  // Update the same goldAmount variable
                                collecting2 = false;
                    ...
                    transform.DOMoveX(depositLocation.position.x, moveSpeed).SetEase(Ease.Linear).OnComplete(() =>
                    {
                        ...
                        DOVirtual.DelayedCall(5f, () =>
                        {
                            ...
                            transform.DORotate(new Vector3(0, 0, 0), 0.5f).SetEase(Ease.Linear).OnComplete(() =>
                            {
                                ...
                                anim.SetBool("Idle", true);
                                coinSound.GetComponent<AudioSource>().Play();
                                goldAmount += 20;  // Update the same goldAmount variable
                                collecting3 = false;
    ...
    {
        PlayerPrefs.SetInt("speed1", miningspeed1);
        PlayerPrefs.Save();
