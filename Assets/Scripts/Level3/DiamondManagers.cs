...
public class DiamondManagers : MonoBehaviour
{
    public DiamondUnlockManager unlockmanager;
    public TMP_Text hiremantext1;
    public TMP_Text hiremantext2;
    public TMP_Text hiremantext3;
    public TMP_Text hiremantext4; // New variable for manager 4
    public TMP_Text hiremantext5; // New variable for manager 5
    public TMP_Text hiremantext6; // New variable for manager 6

    public DiamondBaseMiner1 miner1;
    public DiamondBaseMiner2 miner2;
    public DiamondBaseMiner3 miner3;
    public DiamondBaseMiner4 miner4; // New variable for manager 4
    public DiamondBaseMiner5 miner5; // New variable for manager 5
    public DiamondBaseMiner6 miner6; // New variable for manager 6

    public TMP_Text speed1text;
    public TMP_Text speed2text;
    public TMP_Text speed3text;
    public TMP_Text speed4text; // New variable for manager 4
    public TMP_Text speed5text; // New variable for manager 5
    public TMP_Text speed6text; // New variable for manager 6

    public TMP_Text power1text;
    public TMP_Text power2text;
    public TMP_Text power3text;
    public TMP_Text power4text; // New variable for manager 4
    public TMP_Text power5text; // New variable for manager 5
    public TMP_Text power6text; // New variable for manager 6
