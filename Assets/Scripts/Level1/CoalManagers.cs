...
public class CoalManagers : MonoBehaviour
{
    ...
    public CoalBaseMiner4 miner4; // New variable for manager 4
    public CoalBaseMiner5 miner5; // New variable for manager 5
    public CoalBaseMiner6 miner6; // New variable for manager 6
